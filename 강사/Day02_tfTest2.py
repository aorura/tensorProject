...
x=tf.constant(30)
y=tf.Variable(x+5)
x2=tf.constant([[1.0, 2.0, 3.0]]) #1행 3열
...
inputdata=[[1.0, 2.0, 3.0],[3.0, 4.0, 2.0],[5.0, 2.0, 4.0]]
x3=tf.placeholder(dtype=tf.float32, shape=[None,3])#None,3
w3=tf.Variable([[2.],[2.],[2.]], dtype=tf.float32)#3,1
y3=tf.matmul(x3,w3)
sess.run(tf.global_variables_initializer())
